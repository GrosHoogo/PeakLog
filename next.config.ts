...
const CSP = [
  ...
  "connect-src 'self' https://generativelanguage.googleapis.com https://www.strava.com https://api.maptiler.com https://api.openrouteservice.org https://*.supabase.co wss://*.supabase.co",
  "worker-src blob:",
  "frame-src 'none'",
  "object-src 'none'",
  "base-uri 'self'",
